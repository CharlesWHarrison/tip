---
title: "Clustering matrices (constant likelihood function)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{matrix_clustering-vignette}
...
# Generate 4 clusters of matrices 
p <- 5
m <- 3
...
c4 <- lapply(1:35, function(x) random_mat_normal(mu = 10, num_rows = m, num_cols = p))

# Put all the data into a list
data_list <- c(c1,c2,c3,c4)
