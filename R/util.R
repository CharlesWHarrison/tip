...
#' @param .matrix Matrix. The matrix that may or may not be invertible.
#' @param .step_size Numeric. If necessary, a small value that is ITERATIVELY added to each diagonal element of a matrix until the matrix is invertible.
#' @noRd
